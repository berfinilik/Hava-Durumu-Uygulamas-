...
class WeatherToday : RecyclerView.Adapter<TodayHolder>() {
    ...
    override fun onBindViewHolder(holder: TodayHolder, position: Int) {
        ...
        for ( i in todayForeCast.weather){
            if (i.icon == "01d") {
                holder.imageDisplay.setImageResource(R.drawable.acikhavagunduz)
            }
            if (i.icon == "01n") {
                holder.imageDisplay.setImageResource(R.drawable.onen)
            }
            if (i.icon == "02d") {
                holder.imageDisplay.setImageResource(R.drawable.azbulutlugunduz)
            }
            if (i.icon == "02n") {
                holder.imageDisplay.setImageResource(R.drawable.azbulutlugece)
            }
            if (i.icon == "03d" || i.icon == "03n") {
                holder.imageDisplay.setImageResource(R.drawable.parcalibulutlu)
            }
            if (i.icon == "10d") {
                holder.imageDisplay.setImageResource(R.drawable.gunduzyagmurlu)
            }
            if (i.icon == "10n") {
                holder.imageDisplay.setImageResource(R.drawable.geceyagmurlu)
            }
            if (i.icon == "04d" || i.icon == "04n") {
                holder.imageDisplay.setImageResource(R.drawable.kapalibulutlu)
            }
            if (i.icon == "09d" || i.icon == "09n") {
                holder.imageDisplay.setImageResource(R.drawable.gunduzyagmurlufirtinali)
            }
            if (i.icon == "11d" || i.icon == "11n") {
                holder.imageDisplay.setImageResource(R.drawable.gunduzgokgurultulufirtinali)
            }
            if (i.icon == "13d" || i.icon == "13n") {
                holder.imageDisplay.setImageResource(R.drawable.karyagisi)
            }

            if (i.icon == "50d" || i.icon == "50n") {
                holder.imageDisplay.setImageResource(R.drawable.sisli)
            }
        }
    }
